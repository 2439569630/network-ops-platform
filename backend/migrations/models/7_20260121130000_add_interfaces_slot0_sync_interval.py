...
async def upgrade(db: BaseDBAsyncClient) -> str:
    return """
        ...
        ADD COLUMN IF NOT EXISTS "interfaces_slot0_sync_interval" DOUBLE PRECISION NOT NULL DEFAULT 3600.0;
    """


async def downgrade(db: BaseDBAsyncClient) -> str:
    return """
        ALTER TABLE IF EXISTS "device_configs" DROP COLUMN IF EXISTS "interfaces_slot0_sync_interval";
    """
