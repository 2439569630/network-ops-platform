...
from DeviceLayer import create_device, BaseDevice
...
class MonitorManager:
    ...
    def __new__(cls):
        ...
        if cls._instance is None:
            ...
            # 初始化Redis管理器
            # cls._instance.redis = RedisManager() # Old
            # New uses redis_manager from app.core.redis
    ...
    async def load_devices(self):
        ...
        if devices_data:
            ...
            monitor_interval = SystemConfig.get_int("monitor_interval", 10)
            online_check_interval = SystemConfig.get_int("online_check_interval", 5)
    ...
    async def _save_data_redis(self, device_id: int, data: dict):
        ...
        try:
            ...
            expire_seconds = SystemConfig.get_int("data_retention", 60)
